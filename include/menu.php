...
?>
    ...
    <nav class="green darken-2">
        <div class="nav-wrapper ">
            <a href="./" class="brand-logo center hide-on-large-only"><img src="asset/img/logo.png" alt="" width="30"></a>
            <ul id="slide-out" class="side-nav green darken-2" data-simplebar-direction="vertical">
                <li class="no-padding">
                    <div class="logo-side center green darken-2">
                        <?php
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            if (!empty($data['logo'])) {
                                ...
                                echo '<img class="logoside" src="./asset/img/LogoBantul.png"/>';
                            }
                            if (!empty($data['nama'])) {
                                echo '<h5 class="smk-side">' . $data['nama'] . '</h5>';
                            } else {
                                echo '<h5 class="smk-side">INFORMATIKA UPN</h5>';
                            }
            ...
            <ul class="center hide-on-med-and-down" id="nv">
                <li>
                    <a href="./" class="ams hide-on-med-and-down" style="display: flex; align-items: center;">
                        <img src="asset/img/LogoBantul.png" alt="" width="35" style="margin-right: 5px;">
                        <span style="vertical-align: middle; font-size: 22spx">Dinas Pariwisata Kabupaten Bantul</span>
                    </a>
                </li>
                <li>
                    <div class="grs">
                ...
                <ul id='transaksi' class='dropdown-content green darken-1'>
                    <li><a href="?page=tsm">Surat Masuk</a></li>
                    <?php
                    if ($_SESSION['admin'] != 4) { ?>
                        <li><a href="?page=tsk">Surat Keluar</a></li>
            ...
            <li><a class="dropdown-button" href="#!" data-activates="agenda">Buku Agenda <i class="material-icons md-18">arrow_drop_down</i></a></li>
                ...
                if ($_SESSION['admin'] != 4) { ?>
                    ...
                    <ul id='agenda' class='dropdown-content green darken-1'>
                        <li><a href="?page=gsm">Surat Masuk</a></li>
                        <li><a href="?page=gsk">Surat Keluar</a></li>
                    </ul>
                ...
                if ($_SESSION['admin'] == 1) { ?>
                    ...
                    <ul id='pengaturan' class='dropdown-content green darken-1'>
                        <li><a href="?page=sett">Instansi</a></li>
