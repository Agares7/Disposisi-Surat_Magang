    				    ...
    				    <div class="col m12">
                            <div class="card">
                                ...
                                <div class="card-action">
            		                <a href="?page=sett&sub=usr&act=del&submit=yes&id_user='.$row['id_user'].'" class="btn-large deep-green waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
