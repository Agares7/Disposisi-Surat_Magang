    				    ...
    				    <div class="col m12">
                            <div class="card">
                                ...
                                <div class="card-action">
        		                     <a href="?page=tsm&act=disp&id_surat='.$row['id_surat'].'&sub=del&submit=yes&id_disposisi='.$row['id_disposisi'].'" class="btn-large deep-green waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
