<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if($_SESSION['id_user'] != $id_user AND $_SESSION['id_user'] != 1 AND $_SESSION['admin'] != 3){
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="POST" action="?page=tsm&act=edit" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=tsm" class="btn-large deep-green waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                        </div>
                    </div>
