...
<head>
    ...
    <title>Manajemen Surat BPBD DIY</title>
                    ...
                    <div class="row">
                        ...
                        ?>
                            ...
                            <div class="col s12">
                                <div class="card-content">
                                    ...
                                    ?>
                                    <h5 class="center" id="title"></h5>
                                    <h5 class="center" id="smk"> Sistem Alur Disposisi Surat </h5>
                                    <h5 class="center" id="title"></h5>s
                                    <h5 class="center" id="tittle">
                                        <?php
                                        if (!empty($data['nama'])) {
                                            echo '' . $data['nama'] . '';
                                        } else {
                        ...
                        ?>
                            ...
                            <form class="col s12 m12 offset-4 offset-4" method="POST" action="">
                                ...
                                <div class="input-field col s12">
                                    <button type="submit" class="btn-large waves-effect waves-light green darken-3 col s12" name="submit">LOGIN</button>
                                </div>
                            </form>
                            <!-- Form END -->
                        <?php
