    				    ...
    				    <div class="col m12">
                            <div class="card">
                                ...
                                <div class="card-action">
            		                <a href="?page=sett&sub=hak&act=del&submit=yes&id_hak_akses='.$row['id_hak_akses'].'" class="btn-large deep-green waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
