                                ...
                                if(mysqli_num_rows($query) > 0){
                                    ...
                                    <td>'.$row['hak_akses'].'</td><td>';
                                          echo ' <a class="btn small blue waves-effect waves-light" href="?page=sett&sub=hak&act=edit&id_hak_akses='.$row['id_hak_akses'].'">
                                                 ...
                                                 <a class="btn small deep-green waves-effect waves-light" href="?page=sett&sub=hak&act=del&id_hak_akses='.$row['id_hak_akses'].'"><i class="material-icons">delete</i> DEL</a>
                                                </td>
                                    </tr>
                                </tbody>';
                                    }
