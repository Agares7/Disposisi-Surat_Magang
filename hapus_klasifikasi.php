			    ...
			    <div class="col m12">
                    <div class="card">
                        ...
                        <div class="card-action">
        	                <a href="?page=ref&act=del&submit=yes&id_klasifikasi='.$row['id_klasifikasi'].'" class="btn-large deep-green waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
