                                ...
                                while($row = mysqli_fetch_array($query)){
                                    echo '
                                        ...
                                        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
                                            echo '<a class="btn small green darken-2 waves-effect waves-light"><i class="material-icons">error</i> NO ACTION</a>';
                                        } else {
                                          echo '<a class="btn small blue waves-effect waves-light" href="?page=internal&act=edit&id_internal='.$row['id_kode'].'">
                                                    <i class="material-icons">edit</i> EDIT</a>
                                                <a class="btn small deep-green waves-effect waves-light" href="?page=internal&act=del&id_internal='.$row['id_kode'].'">
