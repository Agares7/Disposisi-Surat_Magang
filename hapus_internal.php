			    ...
			    <div class="col m12">
                    <div class="card">
                        ...
                        <div class="card-action">
        	                <a href="?page=internal&act=del&submit=yes&id_internal='.$row['id_kode'].'" class="btn-large deep-green waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
